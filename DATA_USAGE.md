...
### Identifiers
- **SeemBuilds_User_ID** — an internal identifier assigned to the user for tracking feature access and usage.  
- **APP_User_ID** — an internal identifier assigned to the APP instance.  
...
```json
{
  ...
  "feature_flags": {
    "betaFeatureA": {
      "enabled": false,
      "whitelist": ["<app_user_id1>", "<app_user_id2>"]
    }
  }
}
